...
\begin{document}
	...
	Je remercie tout d'abord l'association Framasoft de m'avoir accepté en tant que stagiaire durant ces 10 semaines.
	\\
	
	Ensuite, je tiens à remercier en particulier mon maître de stage Monsieur Pierre-Yves \textsc{Gosset} pour son aide et sa disponibilité.
	\\
	
	Je remercie aussi l'ensemble des membres de l'association pour leur aide, leurs retours sur mon travail et leur sympathie, bien que je n'aie pas pu rencontrer tout le monde physiquement.
	\\
	
	J'ai une pensée particulière pour les différentes personnes rencontrées sur le lieu de travail lors de ce stage, le tiers-lieu Locaux Motiv'.
	\\
	
	Les développeurs d'ownCloud avec lesquels j'ai principalement été en contact sont également à mentionner : il s'agit de Georg \textsc{Ehrke} et de Thomas \textsc{Müller}.
	\\
	
	Enfin, je remercie également l'ensemble de l'équipe pédagogique de l'IUT d'Orléans pour les connaissances acquises grâce à cette année d'études.
	...
	Dans le cadre des études préparées à l'\textbf{IUT Informatique d'Orléans-La Source}, je devais effectuer un stage d'une durée de 10 semaines afin d'obtenir le Diplôme Universitaire de Technologie. Ce stage a pour but d'acquérir une première expérience professionnelle en validant les connaissances apprises durant l'année et en exerçant des compétences au travers de la réalisation d'un projet professionnel.
	\\
	
	Ce stage s'est pour ma part déroulé du 20 juin au 27 août 2016 au sein de l'association \textbf{Framasoft} dont les buts sont la promotion, la diffusion et le développement de logiciels libres, de services libres en ligne et de la culture libre.
	\\
	...
	\begin{itemize}
		\item \textbf{\textsc{agpl}} : Affero General Public Licence, licence libre créée par la FSF pour les applications web utilisables comme des services.
		...
		\item \textbf{\textsc{dav}} : \textit{Distributed Authoring and Versioning}. Technologie employée pour WebDAV, CalDAV et CardDAV. Plus d'explications dans le glossaire et en annexes.
	...
	En revanche, j'ai eu plus de mal à comprendre les paradigmes utilisés dans la librairie SabreDAV et les standards de gestion de calendrier, notamment à cause de la documentation plutôt moyenne. Ceci m'a amené à faire beaucoup de tests par moi-même pour comprendre leur fonctionnement.
	\\
	...
	\begin{itemize}
		\item \textbf{\href{https://www.calendarserver.org}{CalendarServer}} : Le site du serveur de calendrier et de contacts d'Apple. Contient certains standards propres à Apple. \href{https://www.calendarserver.org/}{https://www.calendarserver.org}
		\item \textbf{\href{http://caldav.calconnect.org}{CalDAV}} : Les standards CalDAV en général. \href{http://caldav.calconnect.org}{http://caldav.calconnect.org}
		\item Le \textbf{manuel pour développeurs} ownCloud \href{https://doc.owncloud.org/server/9.2/developer\_manual}{https://doc.owncloud.org/server/9.2/developer\_manual} et la \textbf{référence de l'API} \href{https://doc.owncloud.org/api}{https://doc.owncloud.org/api} à destination des applications.
		\item Le \textbf{code source d'ownCloud} \href{https://github.com/owncloud/core}{https://github.com/owncloud/core} et celui de l'\textbf{application Calendrier} \href{https://github.com/owncloud/calendar}{https://github.com/owncloud/calendar}.
		\item Le produit fini \textbf{Framagenda} \href{http://framagenda.org}{https://framagenda.org}
		\item La documentation de la librairie utilisée \textbf{SabreDAV} \href{http://sabre.io/dav}{http://sabre.io/dav}
	...
	Le format de fichiers \href{https://tools.ietf.org/html/rfc2445}{iCalendar} est pour sa part un standard encore plus vieux (1998) qui décrit le format d'un fichier agenda. Ce format est beaucoup décrié aujourd'hui car étant assez lourd et complexe à manipuler. Heureusement, il existe de nombreuses librairies nous évitant de traiter directement ce format.
