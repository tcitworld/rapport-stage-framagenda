...
\begin{document}
	...
	\begin{itemize}
		...
		\item La documentation de la bibliothèque utilisée \textbf{SabreDAV} \href{http://sabre.io/dav}{http://sabre.io/dav}
	...
	Le format de fichiers \href{https://tools.ietf.org/html/rfc2445}{iCalendar} est pour sa part un standard encore plus vieux (1998) qui décrit le format d'un fichier agenda. Ce format est beaucoup décrié aujourd'hui car étant assez lourd et complexe à manipuler. Heureusement, il existe de nombreuses bibliothèques nous évitant de traiter directement ce format.
