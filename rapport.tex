...
\begin{document}
	...
	Je remercie aussi l'ensemble des membres de l'association pour leur aide, leurs retour sur mon travail et leur sympathie, bien que je n'aie pas pu rencontrer tout le monde physiquement.
	\\
	...
	Les développeurs d'ownCloud avec lesquels j'ai principalement été en contacts sont également à mentionner : il s'agit de Georg \textsc{Ehrke} et de Thomas \textsc{Müller}.
	\\
	...
	Le format de fichiers \href{https://tools.ietf.org/html/rfc2445}{iCalendar} est pour sa part est un standard encore plus vieux (1998) qui décrit le format d'un fichier agenda. Ce format est beaucoup décrié aujourd'hui car étant assez lourd et complexe à manipuler. Heureusement, il existe de nombreuses librairies nous évitant de traiter directement ce format.
